module.exports = (() => {
    ...
    class PostgresAdapter extends SQLAdapter {
        ...
        /**
         * Make connection string a parse
         */
        ...
        /**
         * Alter table droping primary key
         */
        ...
        generateCreateSequenceQuery(table, columnName) {
            return [
                [
                    ...
                    'START 1',
                    'OWNED BY', [this.escapeField(table), this.escapeField(columnName)].join('.')
                ].join(' '), [
                    'SELECT setval(\'',
                    this.generateSequence(table, columnName),
