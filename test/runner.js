    ...
    if (os.platform() === 'win32') {
        ...
        before(() => {
            if (!process.env.NODE_ENV || process.env.NODE_ENV === 'development') {
                ...
                child_process.execSync('psql -h 127.0.0.1 -c \'drop database if exists nodal_test;\' -U postgres');
                child_process.execSync('psql -h 127.0.0.1 -c \'create database nodal_test;\' -U postgres');
            }
        });
